...
export default function Profile() {
    const { data: addresses, loading, error } = useFetch('https://e-commerce-backend-two-mu.vercel.app/addresses');

    // Get the first address if available
    const userAddress = addresses?.address?.[0];
                        ...
                        <Grid item xs={12}>
                            <Box sx={{ mt: 2 }}>
                                <Typography variant="body2" color="text.secondary">
                                    Account created: {new Date(userAddress?.createdAt).toLocaleDateString()}
                                </Typography>
                                <Typography variant="body2" color="text.secondary">
                                    Last updated: {new Date(userAddress?.updatedAt).toLocaleDateString()}
                                </Typography>
                            </Box>
                        </Grid>
                    </Grid>
